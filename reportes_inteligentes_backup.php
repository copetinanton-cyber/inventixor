...
// Manejar solicitudes AJAX para generar reportes
if (isset($_POST['action'])) {
    ...
    try {
        ...
        switch ($tipo_reporte) {
            ...
            case 'obtener_datos_graficos':
                ...
                echo json_encode(['success' => true, 'graficos' => $graficos]);
                exit;
            ...
            case 'informe_salidas_avanzado':
                ...
                echo json_encode(['success' => true, 'salidas' => $salidas]);
                exit;
            ...
            case 'kpis_rotacion':
                ...
                echo json_encode(['success' => true, 'rotacion' => $rotacion]);
                exit;
            ...
            case 'kpis_avanzados_bi':
                ...
                echo json_encode(['success' => true, 'bi' => $bi]);
                exit;
        ...
        // Limpiar cualquier salida acumulada
        ob_clean();
    ...
    // Limpiar buffer de salida y terminar
    ob_end_clean();
    exit;
}
?>
...
<body>
    ...
    <script>
        ...
        function mostrarDashboardBI() {
            ...
            .catch(error => console.error('Error cargando KPIs avanzados:', error));
        }
